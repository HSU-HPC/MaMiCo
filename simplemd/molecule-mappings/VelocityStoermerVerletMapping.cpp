...
// check 6 sides for reflecting boundaries
  ...
  if (boundary[1] == simplemd::REFLECTING_BOUNDARY) {
    ...
    if ((boundary[0] != simplemd::REFLECTING_BOUNDARY) || (boundary[2] != simplemd::REFLECTING_BOUNDARY)) {
      std::cout << "ERROR simplemd::moleculemappings::VelocityStoermerVerletMapping::initReflectingBoundary: Boundaries 0,2 are not reflecting!" << std::endl;
      exit(EXIT_FAILURE);
    }
  }
  // left
  if (boundary[3] == simplemd::REFLECTING_BOUNDARY) {
    ...
    if ((boundary[0] != simplemd::REFLECTING_BOUNDARY) || (boundary[5] != simplemd::REFLECTING_BOUNDARY)) {
      std::cout << "ERROR simplemd::moleculemappings::VelocityStoermerVerletMapping::initReflectingBoundary: Boundaries 0,5 are not reflecting!" << std::endl;
      exit(EXIT_FAILURE);
    }
  }
  // right
  if (boundary[4] == simplemd::REFLECTING_BOUNDARY) {
    ...
    if ((boundary[2] != simplemd::REFLECTING_BOUNDARY) || (boundary[7] != simplemd::REFLECTING_BOUNDARY)) {
      std::cout << "ERROR simplemd::moleculemappings::VelocityStoermerVerletMapping::initReflectingBoundary: Boundaries 2,7 are not reflecting!" << std::endl;
      exit(EXIT_FAILURE);
    }
  }
  // top
  if (boundary[6] == simplemd::REFLECTING_BOUNDARY) {
    ...
    if ((boundary[5] != simplemd::REFLECTING_BOUNDARY) || (boundary[7] != simplemd::REFLECTING_BOUNDARY)) {
      std::cout << "ERROR simplemd::moleculemappings::VelocityStoermerVerletMapping::initReflectingBoundary: Boundaries 5,7 are not reflecting!" << std::endl;
      exit(EXIT_FAILURE);
    }
  }
#elif (MD_DIM == 3)
  ...
  if (boundary[4] == simplemd::REFLECTING_BOUNDARY) {
    ...
    if ((boundary[0] != simplemd::REFLECTING_BOUNDARY) || (boundary[1] != simplemd::REFLECTING_BOUNDARY) || (boundary[2] != simplemd::REFLECTING_BOUNDARY) ||
      ...
      std::cout << "ERROR simplemd::moleculemappings::VelocityStoermerVerletMapping::initReflectingBoundary: Boundaries 0,1,2,3,5,6,7,8 are not reflecting!"
                << std::endl;
      exit(EXIT_FAILURE);
    }
  }
  ...
  if (boundary[10] == simplemd::REFLECTING_BOUNDARY) {
    ...
    if ((boundary[0] != simplemd::REFLECTING_BOUNDARY) || (boundary[1] != simplemd::REFLECTING_BOUNDARY) || (boundary[2] != simplemd::REFLECTING_BOUNDARY) ||
      ...
      std::cout << "ERROR simplemd::moleculemappings::VelocityStoermerVerletMapping::initReflectingBoundary: Boundaries 0,1,2,9,11,17,18,19 are not reflecting!"
                << std::endl;
      exit(EXIT_FAILURE);
    }
  }
  ...
  if (boundary[12] == simplemd::REFLECTING_BOUNDARY) {
    ...
    if ((boundary[0] != simplemd::REFLECTING_BOUNDARY) || (boundary[3] != simplemd::REFLECTING_BOUNDARY) || (boundary[6] != simplemd::REFLECTING_BOUNDARY) ||
      ...
      std::cout << "ERROR simplemd::moleculemappings::VelocityStoermerVerletMapping::initReflectingBoundary: Boundaries 0,3,6,9,14,17,20,23 are not reflecting!"
                << std::endl;
      exit(EXIT_FAILURE);
    }
  }
  ...
  if (boundary[13] == simplemd::REFLECTING_BOUNDARY) {
    ...
    if ((boundary[2] != simplemd::REFLECTING_BOUNDARY) || (boundary[5] != simplemd::REFLECTING_BOUNDARY) || (boundary[8] != simplemd::REFLECTING_BOUNDARY) ||
      ...
      std::cout
          << "ERROR simplemd::moleculemappings::VelocityStoermerVerletMapping::initReflectingBoundary: Boundaries 2,5,8,11,16,19,22,25 are not reflecting!"
          << std::endl;
      exit(EXIT_FAILURE);
    }
  }
  ...
  if (boundary[15] == simplemd::REFLECTING_BOUNDARY) {
    ...
    if ((boundary[6] != simplemd::REFLECTING_BOUNDARY) || (boundary[7] != simplemd::REFLECTING_BOUNDARY) || (boundary[8] != simplemd::REFLECTING_BOUNDARY) ||
      ...
      std::cout
          << "ERROR simplemd::moleculemappings::VelocityStoermerVerletMapping::initReflectingBoundary: Boundaries 6,7,8,14,16,23,24,25 are not reflecting!"
          << std::endl;
      exit(EXIT_FAILURE);
    }
  }
  ...
  if (boundary[21] == simplemd::REFLECTING_BOUNDARY) {
    ...
    if ((boundary[17] != simplemd::REFLECTING_BOUNDARY) || (boundary[18] != simplemd::REFLECTING_BOUNDARY) || (boundary[19] != simplemd::REFLECTING_BOUNDARY) ||
        ...
        (boundary[24] != simplemd::REFLECTING_BOUNDARY) || (boundary[25] != simplemd::REFLECTING_BOUNDARY)) {
      std::cout
          << "ERROR simplemd::moleculemappings::VelocityStoermerVerletMapping::initReflectingBoundary: Boundaries 17,18,19,20,22,23,24,25 are not reflecting!"
          << std::endl;
      exit(EXIT_FAILURE);
    }
  }
