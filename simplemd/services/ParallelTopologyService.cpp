...
simplemd::services::ParallelTopologyService::ParallelTopologyService(
    ...
    : _domainSize(domainSize), _domainOffset(domainOffset),
      ...
      _globalNumberOfCells(
          computeGlobalNumberOfCells(meshWidth, numberProcesses, domainSize))
#if (MD_PARALLEL == MD_YES)
      ,
...
#endif
            int neighbourRank = ((x + ((int)_processCoordinates[0]) +
                                  ((int)_numberProcesses[0])) %
                                 _numberProcesses[0])
#if (MD_DIM > 1)
                                + ((y + ((int)_processCoordinates[1]) +
                                    ((int)_numberProcesses[1])) %
                                   _numberProcesses[1]) *
                                      _numberProcesses[0]
#endif
#if (MD_DIM > 2)
                                + ((z + ((int)_processCoordinates[2]) +
                                    ((int)_numberProcesses[2])) %
                                   _numberProcesses[2]) *
...
bool simplemd::services::ParallelTopologyService::reduceGhostCellViaBuffer(
  ...
  // positive range.
  cellCoords =
      (((int)(_processCoordinates[2] + _numberProcesses[2])) + cellCoords) %
      _numberProcesses[2];
  ...
  cellCoords =
      (((int)(_processCoordinates[1] + _numberProcesses[1])) + cellCoords) %
      _numberProcesses[1];
  ...
  cellCoords =
      (((int)(_processCoordinates[0] + _numberProcesses[0])) + cellCoords) %
      _numberProcesses[0];
