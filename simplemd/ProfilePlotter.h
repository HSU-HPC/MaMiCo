...
public:
   ...
   * that this is the respective timestep -
...
private:
   ...
   * intersection of the global profile position
   *  with the local domain. If a profile does not intersect the local domain,
   ...
   * process.
   *  In that case, the ProfilePlotterMapping will be allocated, but the
   * respective entry in this vector will
