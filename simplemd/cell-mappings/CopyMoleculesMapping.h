 ...
 *  After creating copies of the molecules, they are deleted from the LinkedCell-structure.
 *  This mapping is used for reorganisation of the memory within the MoleculeService.
 *
