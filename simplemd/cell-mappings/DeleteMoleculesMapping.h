...
namespace simplemd {
namespace cellmappings { class DeleteMoleculesMapping; }
}

/** deletes all molecules within the cells. The molecules are not only removed
 * from the lists in the cells,
 *  they are also deleted from the MoleculeService, i.e. they are completely
 * removed.
 *  This mapping is applied in the BoundaryTreatment class: After the force
 * computations, the ghost cells do not
