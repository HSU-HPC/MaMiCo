 ...
 * outer (ghost) cells,
 *  puts them into the respective inner cells (w.r.t. periodicity) and deletes
 * them from the ghost cell.
 *  In case of (MPI-)parallel computations, the molecules are automatically
 * adapted in the positions and sent
