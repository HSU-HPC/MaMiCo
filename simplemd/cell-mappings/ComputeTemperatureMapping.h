...
class simplemd::cellmappings::ComputeTemperatureMapping {
  public:
    ...
    _parallelTopologyService(parallelTopologyService),_molecularPropertiesService(molecularPropertiesService),
    ...
    void endCellIteration(){
      ...
      #endif
        std::stringstream ss; ss << "Temperature_" << _localMDSimulation << "_" << _parallelTopologyService.getRank() << ".dat";
