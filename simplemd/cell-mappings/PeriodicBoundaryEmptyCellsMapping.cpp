...
void simplemd::cellmappings::PeriodicBoundaryEmptyCellsMapping::
setProcessCoordinates(const tarch::la::Vector<MD_DIM,unsigned int>& processCoordinates){
  _processCoordinates = processCoordinates;
}


void simplemd::cellmappings::PeriodicBoundaryEmptyCellsMapping::
setNumberOfProcesses(const tarch::la::Vector<MD_DIM,unsigned int>& numberProcesses){
