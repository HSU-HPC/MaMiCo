...
std::string simplemd::configurations::RDFConfiguration::getTag() const { return "rdf-configuration"; }

bool simplemd::configurations::RDFConfiguration::isValid() const { return _isValid; }
