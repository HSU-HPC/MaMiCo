...
void simplemd::configurations::MolecularDynamicsConfiguration::
...
std::string simplemd::configurations::MolecularDynamicsConfiguration::getTag() const {
...
bool simplemd::configurations::MolecularDynamicsConfiguration::isValid() const {
  ...
  return isValid && _domainConfiguration.isValid() && _moleculeConfiguration.isValid()
  && _vtkConfiguration.isValid() && _simulationConfiguration.isValid()
  && _mpiConfiguration.isValid()
  && _rdfConfiguration.isValid()
  && _checkpointConfiguration.isValid()
  ;
}
