...
const std::string simplemd::configurations::SimulationConfiguration::OVERLAP_COMMUNICATION_WITH_FORCE_COMPUTATION("overlap-communication-with-force-computation");
...
void simplemd::configurations::SimulationConfiguration::
parseSubtag( tinyxml2::XMLElement* node ){
  ...
  // read if in parallel simulation force and send operations shall be overlapped
