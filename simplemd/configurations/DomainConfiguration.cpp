...
#elif (MD_DIM==3)
 = { "bottom-south-west", "bottom-south", "bottom-south-east",
     "bottom-west", "bottom", "bottom-east",
     "bottom-north-west", "bottom-north", "bottom-north-east",
     "south-west", "south", "south-east", "west", "east", "north-west", "north", "north-east",
     "top-south-west", "top-south", "top-south-east",
     "top-west", "top", "top-east",
...
_kB(0.0),
_blockSize(0),
_boundary(simplemd::PERIODIC_BOUNDARY),
_checkpointFilestem(""),
...
void simplemd::configurations::DomainConfiguration::
parseSubtag( tinyxml2::XMLElement* node ){
  ...
  // get checkpoint info
  _initFromSequentialCheckpoint = false; strBuf = "";
