...
/** Velocity imposition scheme following the respective paper by Nie et al., J.
 * Fluid. Mech. 500, 2004
 *
...
public:
  NieVelocityImposition(coupling::interface::MDSolverInterface<
...
private:
   ...
   * innermostLayer. For, e.g.,
   *  outermostLayer=2 and innermostLayer=3, the layers for imposition are
   * located in the 3rd and 4th strip of cells (we start counting from cell
   * layer=0 which corresponds to the outermost,
