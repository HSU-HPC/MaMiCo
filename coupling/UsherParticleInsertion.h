...
/** handles particle insertion (via Usher algorithm) and random particle
 * deletion.
 *  We currently also allow particle insertion in energyy holes, i.e. for
 * energy(particle)==0.0.
 *
...
private:
   ...
   *  in the position entry of the molecule 'molecule'. The method returns
   * Insertion if a position has been
