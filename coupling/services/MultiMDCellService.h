  ...
  public:
    ...
    double sendFromMD2Macro(
      ...
      if(_postMultiInstanceFilterPipeline == nullptr) {
          ...
          _postMultiInstanceFilterPipeline = new coupling::FilterPipeline<dim>(_macroscopicCells, coupling::Scope::postMultiInstance, _multiMDService, _filterPipelineConfiguration.c_str());
      }
      #endif
