...
public coupling::services::MacroscopicCellService<dim> {
  public:
	 ...
	 */
	void initFiltering() { _filterPipeline = new coupling::FilterPipeline<dim>(_macroscopicCells.getMacroscopicCells(), coupling::Scope::perInstance, _multiMDService, _filterPipelineConfiguration); }
