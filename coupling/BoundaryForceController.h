...
/** There is an interface method applyBoundaryForce which triggers potential boundary forcing in each macroscopic
...
class coupling::BoundaryForceController {
  public:
    ...
    *  @param mdSolverInterface interface to the molecular dynamics solver*/
    ...
    /** iterates over all linked cells of the given macroscopic cell and applies the cellmapping for the boundary force
