...
/** describes a quadratic/ cubic macroscopic cell filled with fluid (no linked cells). Base class for the class coupling::datastructures::MacroscopicCellWithLinkedCells
 *	@brief defines the cell type with cell-averaged quantities only (no linked cells).
...
class coupling::datastructures::MacroscopicCellWithLinkedCells: public coupling::datastructures::MacroscopicCell<dim> {
  public:
    /** Constructor: initialises the macroscopic cell based on the assumption of having blockSize linked cells;
     *  @param blockSize represents the number of linked cells in all spatial directions.
     */
	 ...
	 * @param cell the linked cell that should be inserted into the macroscopic cell
