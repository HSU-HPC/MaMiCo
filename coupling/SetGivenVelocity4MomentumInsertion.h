...
/** interpretes the vector in the microscopicMomentum-buffer as velocity and
 * sets this value in the
...
public:
  SetGivenVelocity4MomentumInsertion(coupling::interface::MDSolverInterface<
