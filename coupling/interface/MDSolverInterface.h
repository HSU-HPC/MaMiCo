...
class coupling::interface::MDSolverInterface {
  ...
  /** Destructor */
    ...
    /** This function specifies a particular linked cell inside a macroscopic cell.
    ...
    /** This function sets a random velocity in the vector 'initialVelocity'. This velocity is sampled from
    ...
    /** This function sets up the potential energy landscape over the domain spanned by indexOfFirstMacroscopicCell and
    ...
    /** This function specifies the local index vector (w.r.t. lexicographic ordering of the linked cells in the MD simulation,
     *  for the linked cell that the position 'position' belongs to. This method is
	 ...
	 *	@param position
	 *	@return the local index vector for the linked cell that the position 'position' belongs to
	 *	@sa getLinkedCell()
     */
    ...
    /** This function assumes that a molecule is placed somewhere inside the linked cell at index
    ...
    /** This function is called each time when MaMiCo tried to insert/ delete molecules from the MD simulation. As a consequence,
    ...
    /** This function is called each time when MaMiCo tried to insert momentum in the MD simulation. For the builtin MD simulation,
