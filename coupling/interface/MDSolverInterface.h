...
local domain; the very
     *  first macroscopic cell inside the global MD domain (or local MD domain)
is thus given by coordinates
...
ordering of the linked cells in the MD simulation,
     *  for the linked cell that the position 'position' belongs to. This method
is
...
with "molecule".
   ...
   * the MD simulation. For the builtin MD simulation,
