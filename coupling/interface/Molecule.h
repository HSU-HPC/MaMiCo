...
namespace coupling {
namespace interface { template <unsigned int dim> class Molecule; }
}

/** This class provides interface to access a single molecule in the MD
 * simulation. The MaMiCo molecule in datastructures also inherits from this
 * class.
