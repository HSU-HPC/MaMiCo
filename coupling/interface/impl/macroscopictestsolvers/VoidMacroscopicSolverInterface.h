...
namespace coupling {
  namespace interface {
    ...
    class VoidMacroscopicSolverInterface;
  }
}
 ...
 */
template<unsigned int dim>
class coupling::interface::VoidMacroscopicSolverInterface: public coupling::interface::TestMacroscopicSolverInterface<dim> {
  public:
