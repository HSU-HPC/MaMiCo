...
template <class LinkedCell, unsigned int dim> class ComputeVelocityBinMapping;
}
} // namespace coupling
 ...
 */
template <class LinkedCell, unsigned int dim> class coupling::cellmappings::ComputeVelocityBinMapping {
public:
  /** Constructor
   *	@param mdSolverInterface
   */
  ComputeVelocityBinMapping(coupling::interface::MDSolverInterface<LinkedCell, dim>* const mdSolverInterface, tarch::la::Vector<dim, double>* velocity,
                            tarch::la::Vector<dim, double>* velocityPlus, tarch::la::Vector<dim, double>* velocityMinus, unsigned int* numberParticles,
                            unsigned int* numberParticlesPlus, unsigned int* numberParticlesMinus)
