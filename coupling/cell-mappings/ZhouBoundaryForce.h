 ...
 *obtained from various MD simulation runs at different temperature and density
 *values. The investigated range is:
...
public:
   ...
   *encountered and this molecule is close to that boundary (distance smaller
   *than 2.5, cf. Zhou paper), the respective force contribution in that
   *dimension is added/subtracted.
   *	@param position
   *	@return force
   */
