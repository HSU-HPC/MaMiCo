...
namespace coupling {
  namespace cellmappings {
    ...
    class ComputeTemperatureBinMapping;
  }
}
 ...
 */
template<class LinkedCell,unsigned int dim>
class coupling::cellmappings::ComputeTemperatureBinMapping {
  public:
    /** Constructor
	 *	@param mdSolverInterface
	 */
	ComputeTemperatureBinMapping(coupling::interface::MDSolverInterface<LinkedCell,dim> * const mdSolverInterface,
    tarch::la::Vector<dim, double>* velocity, double* temperature):
