...
using I07 =
    coupling::indexing::CellIndex<3, coupling::indexing::IndexTrait::vector, coupling::indexing::IndexTrait::local, coupling::indexing::IndexTrait::md2macro>;
...
using I11 =
    coupling::indexing::CellIndex<3, coupling::indexing::IndexTrait::vector, coupling::indexing::IndexTrait::local, coupling::indexing::IndexTrait::noGhost>;
using I12 = coupling::indexing::CellIndex<3, coupling::indexing::IndexTrait::md2macro, coupling::indexing::IndexTrait::noGhost>;
using I13 =
    coupling::indexing::CellIndex<3, coupling::indexing::IndexTrait::vector, coupling::indexing::IndexTrait::md2macro, coupling::indexing::IndexTrait::noGhost>;
using I14 =
    coupling::indexing::CellIndex<3, coupling::indexing::IndexTrait::local, coupling::indexing::IndexTrait::md2macro, coupling::indexing::IndexTrait::noGhost>;
using I15 = coupling::indexing::CellIndex<3, coupling::indexing::IndexTrait::vector, coupling::indexing::IndexTrait::local,
