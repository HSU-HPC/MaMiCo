...
FLAGS="-fPIC -DSIMPLE_MD -DMDDim3 -std=c++20 -pedantic -Werror -Wno-unknown-pragmas -Wall -DMDCoupledParallel -fPIC -DTarchParallel -DMPICH_IGNORE_CXX_SEEK -DENABLE_POST_MULTI_INSTANCE_FILTERING"
# -DMDCoupledDebug"
