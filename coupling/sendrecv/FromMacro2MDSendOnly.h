 ...
 *  not to receive any data, e.g. due to MD running on different ranks. Derived from the class coupling::sendrecv::SendReceiveBuffer
 *	@brief SendReceiveBuffer for transfer of quantities from a macroscopic solver to
 *  the macroscopic cells. Only sends data but expects 
 *  not to receive any data. Derived from the class coupling::sendrecv::SendReceiveBuffer
