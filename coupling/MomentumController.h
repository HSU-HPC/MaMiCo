...
/** controles the momentum in a macroscopic cell. This class can compute the momentum and set
...
class coupling::MomentumController {
  public:
    ...
    /** sets the momentum of a macroscopic cell to newMomentum. This cell does not consider the kinetic energy
     *  of the system, so the kinetic energy will be different after executing this method!
     *  In order to also retain the kinetic energy, one might compute the kinetic energy before calling this method
     *  (using the KineticEnergyController) and set the old kinetic energy afterwards (again using the KineticEnergyController).
