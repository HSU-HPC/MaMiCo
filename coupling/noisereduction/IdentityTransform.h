...
template <unsigned int dim> class IdentityTransform;
}
} // namespace coupling

/** Dummy noise reduction class for not performing any filtering at all. Data
 * from MD is kept unmodified
 *
 *  @author Piet Jarmatz
 */
template <unsigned int dim> class coupling::noisereduction::IdentityTransform : public coupling::noisereduction::NoiseReduction<dim> {
public:
