...
namespace coupling {
namespace noisereduction { template <unsigned int dim> class POD; }
}
...
public:
  POD(const coupling::IndexConversion<dim> &indexConversion,
...
private:
  ...
  unsigned int _spatialIndex; // cell counter, should run from zero to
                              ...
                              // iteration of ProcessInnerMacroscopicCells
