...
public:
   ...
   *  algorithm requires it. Other algorithms may not require it; the trivial
   * NoParticleInsertion-implementation
   *  which does not do anything obviously does not require a valid potential
   * energy landscape.
   */
