...
// =============================---==============
#ifndef __NavierStokesSolver_ADERDG_Variables_CLASS_HEADER__
#define __NavierStokesSolver_ADERDG_Variables_CLASS_HEADER__
 ...
 * specification file
 **/
struct NavierStokes::AbstractNavierStokesSolver_ADERDG::VariableMetrics {
 ...
 **/
class NavierStokes::AbstractNavierStokesSolver_ADERDG::VariableShortcuts : public NavierStokes::AbstractNavierStokesSolver_ADERDG::VariableMetrics {
public:
 ...
 **/
class NavierStokes::AbstractNavierStokesSolver_ADERDG::VariableMultiplicities : public NavierStokes::AbstractNavierStokesSolver_ADERDG::VariableMetrics {
public:
  /// positions of fields inside the unknown vector (solution vector) Q
 ...
 *
 **/
class NavierStokes::AbstractNavierStokesSolver_ADERDG::VariableNames : public NavierStokes::AbstractNavierStokesSolver_ADERDG::VariableMetrics {
public:
 ...
 * 
 *    void somewhere() {
 *       using namespace NavierStokes::NavierStokesSolver_ADERDG_Variables::shortcuts;
 *       Q[foo] = 17;
 *    }
 *
 * instead of
 * 
 *    void somewhere() {
 *       NavierStokes::AbstractNavierStokesSolver_ADERDG::VariableNames q;
 *       Q[q.foo] = 17;
 *    }
 *
 **/
namespace NavierStokes {
  namespace NavierStokesSolver_ADERDG_Variables {
    namespace shortcuts {
      constexpr int rho = 0;
      constexpr int j = 1;
      constexpr int E = 4;
  ...
  } // end of namespace NavierStokes::NavierStokesSolver_ADERDG_Variables 
} // end of namespace NavierStokes
...
class NavierStokes::AbstractNavierStokesSolver_ADERDG::ReadOnlyVariables : public NavierStokes::AbstractNavierStokesSolver_ADERDG::VariableMetrics {
  private:
...
class NavierStokes::AbstractNavierStokesSolver_ADERDG::Variables : public NavierStokes::AbstractNavierStokesSolver_ADERDG::VariableMetrics{
  private:
    double* _Q;
  public:
    static constexpr int SizeVariables  = 5;
...
class NavierStokes::AbstractNavierStokesSolver_ADERDG::Fluxes : public NavierStokes::AbstractNavierStokesSolver_ADERDG::VariableMetrics {
  private:
    double** _F;
  public:
