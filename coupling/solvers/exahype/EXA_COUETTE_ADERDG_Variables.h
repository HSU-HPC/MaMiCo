...
// =============================---==============
#ifndef __EXA_COUETTE_ADERDG_Variables_CLASS_HEADER__
#define __EXA_COUETTE_ADERDG_Variables_CLASS_HEADER__
 ...
 * specification file
 **/
struct couette::AbstractEXA_COUETTE_ADERDG::VariableMetrics {
 ...
 **/
class couette::AbstractEXA_COUETTE_ADERDG::VariableShortcuts : public couette::AbstractEXA_COUETTE_ADERDG::VariableMetrics {
public:
 ...
 **/
class couette::AbstractEXA_COUETTE_ADERDG::VariableMultiplicities : public couette::AbstractEXA_COUETTE_ADERDG::VariableMetrics {
public:
  /// positions of fields inside the unknown vector (solution vector) Q
 ...
 *
 **/
class couette::AbstractEXA_COUETTE_ADERDG::VariableNames : public couette::AbstractEXA_COUETTE_ADERDG::VariableMetrics {
public:
 ...
 * 
 *    void somewhere() {
 *       using namespace couette::EXA_COUETTE_ADERDG_Variables::shortcuts;
 *       Q[foo] = 17;
 *    }
 *
 * instead of
 * 
 *    void somewhere() {
 *       couette::AbstractEXA_COUETTE_ADERDG::VariableNames q;
 *       Q[q.foo] = 17;
 *    }
 *
 **/
namespace couette {
  namespace EXA_COUETTE_ADERDG_Variables {
    namespace shortcuts {
      constexpr int rho = 0;
      constexpr int u = 1;
      constexpr int E = 4;
  ...
  } // end of namespace couette::EXA_COUETTE_ADERDG_Variables 
...
class couette::AbstractEXA_COUETTE_ADERDG::ReadOnlyVariables : public couette::AbstractEXA_COUETTE_ADERDG::VariableMetrics {
  private:
...
class couette::AbstractEXA_COUETTE_ADERDG::Variables : public couette::AbstractEXA_COUETTE_ADERDG::VariableMetrics{
  private:
    double* _Q;
  public:
    static constexpr int SizeVariables  = 5;
...
class couette::AbstractEXA_COUETTE_ADERDG::Fluxes : public couette::AbstractEXA_COUETTE_ADERDG::VariableMetrics {
  private:
    double** _F;
  public:
