...
namespace coupling {
/** @brief all numerical solvers are defined in the namespace, and their
 * interfaces  */
namespace solvers {
...
public:
  ...
  /** for the first entry of the vector is the analytic solution of the Couette
   * scenario returned, given by: u(z,t)= V(1-z/H) - 2V/pi*sum_k=1^infty
   * 1/k*sin(k*pi*z/H)*exp(-k^2 pi^2/H^2 * nu*t) The other two entries are 0
