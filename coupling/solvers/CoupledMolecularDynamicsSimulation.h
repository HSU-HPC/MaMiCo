...
public simplemd::MolecularDynamicsSimulation {
  public:
    ...
    /** returns the boundary treatment of the simulation; this is needed by the coupling to synchronize molecules
    ...
    /** returns the parallel topology service; this is needed by the MD solver interface in coupling. */
    simplemd::services::ParallelTopologyService& getParallelTopologyService(){return *_parallelTopologyService;}
    /** returns the molecule service; this is needed by the MD solver interface in coupling. */
