...
class coupling::error::ErrorEstimation {
  public:
    ...
    ErrorEstimation(double velocity,double temperature,
			...
			_desiredAbsErrorPressure(0.05),  _desiredRelErrorPressure(0.05),
	 ...
	 */
	enum errorBaseQuantity{Velocity=0/**< error in Velocity*/, Density=1/**< error in Density*/, Temperature=2/**< error in Temperature*/, Pressure=3/**< error in Pressure*/};
	...
	enum errorType{Relative=0/**< Relative error */, Absolute=1/**< Absolute error */};
	 ...
	 double getCorrectorNumberOfSamples(errorBaseQuantity BaseQuantity, errorType Type){
        ...
        if (BaseQuantity==Velocity){
			...
			return requiredSamplesV(Type==Relative ? _desiredRelErrorVelocity : _desiredAbsErrorVelocity, _temperature, _soundSpeed, Type==Relative ? _velocity : 1, _numberOfParticle, _particleMass);
