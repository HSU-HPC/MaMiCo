 ...
 *  for Espresso in the coupling tool are correct or not. To do that, I create
 * two lists, one which gets data
 *  from Espresso data structures and other from coupling tool data structures
