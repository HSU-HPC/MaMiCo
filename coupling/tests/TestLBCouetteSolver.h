  ...
  virtual void run() {
    ...
    const coupling::IndexConversion<3> indexConversion(
        ...
        coupling::paralleltopology::
            XYZ, // parallel topology of MD/MaMico -> should not play a role
      ...
      for (coords[1] = 0; coords[1] < globalNumberMacroscopicCells[1] + 2;
        ...
        for (coords[0] = 0; coords[0] < globalNumberMacroscopicCells[0] + 2;
          ...
          for (unsigned int i = 0; i < ranks.size(); i++) {
            ...
            processCoords[1] = (ranks[i] - processCoords[2] * processes[0] *
      ...
      for (coords[1] = 0; coords[1] < globalNumberMacroscopicCells[1] + 2;
        ...
        for (coords[0] = 0; coords[0] < globalNumberMacroscopicCells[0] + 2;
          ...
          if (contained) {
            ...
            recvBuffer[recvBuffer.size() - 1]
                ->setMacroscopicMomentum(mass * localVel);
          }
        }
      }
    }
