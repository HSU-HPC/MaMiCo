...
#include "cells.hpp"
	...
	if (_espressoMDSolverInterface != NULL){delete _espressoMDSolverInterface; _espressoMDSolverInterface = NULL;}
	...
	tarch::configuration::ParseConfiguration::parseConfiguration<coupling::configurations::MaMiCoConfiguration<3> >(filenameMamico,"mamico",_configurationMamico);
	...
	// Read Temperature from the configuration file and set the temperature for the coupled simulation 
