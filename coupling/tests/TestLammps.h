 ...
 * methods of the MDSolverInterface
 *  as well as initialisation routines which can be re-used by other inherited
 * test cases.
...
protected:
   ...
   * respectively. This method supports dim=2 and dim=3.
   ...
   * be called after
   *  loadLammpsTestConfiguration() and loadMacroscopicSolverConfiguration(). We
   * assume a valid configuration file
