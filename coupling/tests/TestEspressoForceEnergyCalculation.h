...
private: 
    /* This test function is used on a test domain ,which consists of 8 cells and each cell conatin a molecule in the center of the cell, in this function first we add an molecule at the center of the domain , equidistant from all the molecules at time t=0. Then we compute the force acting on that molecule as well as its potential energy. The force should be zero ( the forces are equal in magnitude and opposite in direction), while the potential energy has to be non zero */
