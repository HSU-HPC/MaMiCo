 ...
 * inside the EspressoMDSolverInterface.
 *  In this class, I derive from TestEspresso and have a very simple 2*2*2 grid,
 * with 8 particles, all located at the center of each cell
 *  I add a single particle at the center of the domain. In this simple
 * scenario, the net force acting on the new particle should be
 *  zero, while its potential energy should be greater than zero.
 *  Also I provide a very simple test to the method
