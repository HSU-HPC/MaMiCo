...
private:
	...
	/* This test function adds a molecule to the simulation domain at time t=0 and at the location (0.05,0.05,0.05). Then it iterates over all the molecules in the domain and calculates the number of molecules */
	...
	/* This function, first call the addParticleTest() function and then updates the ghost layers and prints them to see if the added particle has been updated in the ghost layers */
