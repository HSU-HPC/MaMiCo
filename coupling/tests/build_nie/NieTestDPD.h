...
class NieTest: public Test {
  ...
  public:
    ...
    virtual void run(){
      ...
      const double density = 3.0;         // density of particle system; DPD value: 3.0
      const double kinVisc = 0.54/density; // kinematic viscosity (cf. paper by Nie et al.); DPD value: 0.54/density
      const double temp    = 1.0;          // temperature of MD system; DPD value: 1.0
