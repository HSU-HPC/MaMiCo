...
${COMPILER} ${MAMICO_PATH}/coupling/configurations/ParticleInsertionConfiguration.cpp ${DEFINES} -I${MPI_INCLUDE_PATH} -I${MAMICO_PATH} -I${LAMMPS_PATH} -c -o ${BUILD_PATH}/ParticleInsertionConfiguration.o
${COMPILER} ${MAMICO_PATH}/tarch/utils/RandomNumberService.cpp ${DEFINES} -I${MPI_INCLUDE_PATH} -I${MAMICO_PATH} -I${LAMMPS_PATH} -c -o ${BUILD_PATH}/RandomNumberService.o
${COMPILER} ${MAMICO_PATH}/coupling/tests/main_lammps.cpp ${DEFINES} -I${MPI_INCLUDE_PATH} -I${MPI_INCLUDE_PATH} -I${LAMMPS_PATH} -c -o ${BUILD_PATH}/main_lammps.o
