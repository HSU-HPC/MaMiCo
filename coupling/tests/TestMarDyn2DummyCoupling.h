...
private:
  ...
  void init() {
    ...
    tarch::configuration::ParseConfiguration::parseConfiguration<coupling::configurations::MaMiCoConfiguration<3>>(mamicoConfigFile, "mamico", mamicoConfig);
    ...
    _macroscopicCellService = new coupling::services::MacroscopicCellServiceImpl<MarDynCell, 3>(
        0, _marDynMDSolverInterface, DummySolverInterfaceService::getInstance().getInterface(), numberProcesses, rank,
        ...
        mamicoConfig.getTransferStrategyConfiguration(), mamicoConfig.getParallelTopologyConfiguration(), numberMDTimestepsPerCouplingCycle,
