  ...
  public:
    ...
    void compileTest(){
        ...
        coupling::services::MacroscopicCellService<dim> *macroscopicCellService = new coupling::services::MacroscopicCellServiceImpl<simplemd::LinkedCell,dim>(
          0,mdSolverInterface,macroscopicSolverInterface,numberProcesses,rank, particleInsertionConfiguration,
          momentumInsertionConfiguration,boundaryForceConfiguration,transferStrategyConfiguration,parallelTopologyConfiguration, numberMDTimestepsPerCouplingCycle,
