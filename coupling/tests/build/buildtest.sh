...
rm ${BUILD_PATH}/*.o;
parallel=$1;
FLAGS="-DMDDim3 -DMDCoupledDebug -std=c++11 -pedantic -Werror -Wall -DTarchDebug"
...
if [ "${parallel}" == "parallel" ]
then
    mpicxx ${MAMICO_PATH}/coupling/configurations/ParticleInsertionConfiguration.cpp ${FLAGS} -DMDCoupledParallel -I${MPI_PATH} -I${MAMICO_PATH} -c -o ${BUILD_PATH}/ParticleInsertionConfiguration.o
    mpicxx ${MAMICO_PATH}/coupling/solvers/CoupledMolecularDynamicsSimulation.cpp ${FLAGS} -DMDCoupledParallel -I${MPI_PATH} -I${MAMICO_PATH} -c -o ${BUILD_PATH}/CoupledMolecularDynamicsSimulation.o
    mpicxx ${MAMICO_PATH}/coupling/tests/main.cpp ${FLAGS} -DMDCoupledParallel -I${MPI_PATH} -I${MAMICO_PATH} -c -o ${BUILD_PATH}/main.o
