...
/** test class for dummy solver interface and dummy solver interface service. Here I test all the functions defined in the dummy 
 *	solver interface and interface service for a test scenario, consisting of 18*18*18 mesh and allocate send and receive buffers
...
public:
    ...
    virtual void testDummySolverInterface(){
		// Simple test scenario, 12*12*12 mesh and check whether a cell sends to or receivs from MD solver
    ...
    virtual void testDummySolverInterfaceService(){
		...
		// Update the sendCounter or recvCounter based on whether the cell sends data to or receives data from MD Solver		
