 ...
 *respective Cartesian topology that is applied to the MD simulation. This class
 *solely performs the conversion rank<-> process coordinates, assuming a
 *Cartesian grid-like splitting of the MD domain. It is the base class of the
 *classe ZYXTopology and XYZTopology.
 *	@brief This class performs the conversion rank <-> process coordinates.
 *	@tparam dim Number of dimensions; it can be 1, 2 or 3
 *  @author Philipp Neumann
 */
template <unsigned int dim> class coupling::paralleltopology::ParallelTopology {
public:
  /** Destructor */
