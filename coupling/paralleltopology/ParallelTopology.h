 ...
 *  that is applied to the MD simulation. This class solely performs the
 * conversion rank<-> process coordinates,
 *  assuming a Cartesian grid-like splitting of the MD domain. It is the base
 * class of the classe ZYXTopology and XYZTopology.
