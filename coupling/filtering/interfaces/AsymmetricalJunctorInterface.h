...
class coupling::filtering::AsymmetricalJunctorInterface
...
public:
  AsymmetricalJunctorInterface(
      ...
      : // The first cell data set in stored in FI's member variables...
        coupling::filtering::FilterInterface<dim>(
            inputCellVector1, outputCellVector1, filteredValues, type),
  ...
  updateCellData(std::vector<coupling::datastructures::MacroscopicCell<dim> *>
    ...
    coupling::filtering::FilterInterface<dim>::updateCellData(
        new_inputCellVector1, new_outputCellVector1);
  }
