...
/*
 * Filter that reads cell data from a specified file in .csv format and then
 * writes that data to its output cells.
 *
 * Input format must be compliant to the usual MaMiCo CSV format (using ';' as
 * separator). The following order is assumed:
 * - current iteration
