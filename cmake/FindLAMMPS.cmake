...
find_path(LAMMPS_INCLUDE_DIR lammps/lammps.h HINTS ${LAMMPS_DIR} ${LAMMPS_DIR}/build  ${LAMMPS_DIR}/build/includes)

find_path(LAMMPS_SRC_DIR lammps.h HINTS ${LAMMPS_DIR} ${LAMMPS_DIR}/src)
