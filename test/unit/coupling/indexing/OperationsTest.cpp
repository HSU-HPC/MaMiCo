...
public:
  ...
  void testConvertToScalarOutOfDomain() {
    ...
    std::vector<Global_IdxT> global_corners{Global_IdxT{{-1, -1, -1}}, Global_IdxT{{14, -1, -1}}, Global_IdxT{{-1, 14, -1}}, Global_IdxT{{14, 14, -1}},
                                            Global_IdxT{{-1, -1, 14}}, Global_IdxT{{14, -1, 14}}, Global_IdxT{{-1, 14, 14}}, Global_IdxT{{14, 14, 14}}};
    for (const auto& corner : global_corners)
      CPPUNIT_ASSERT_THROW(convertToScalar(corner), std::runtime_error);
    std::vector<Global_IdxT> md2m_corners{Global_IdxT{{3, 3, 3}},  Global_IdxT{{10, 3, 3}},  Global_IdxT{{3, 10, 3}},  Global_IdxT{{10, 10, 3}},
                                          Global_IdxT{{3, 3, 10}}, Global_IdxT{{10, 3, 10}}, Global_IdxT{{3, 10, 10}}, Global_IdxT{{10, 10, 10}}};
  ...
  void testConvertToScalarInDomain() {
    std::vector<Global_IdxT> global_corners{Global_IdxT{{0, 0, 0}},  Global_IdxT{{13, 0, 0}},  Global_IdxT{{0, 13, 0}},  Global_IdxT{{13, 13, 0}},
                                            Global_IdxT{{0, 0, 13}}, Global_IdxT{{13, 0, 13}}, Global_IdxT{{0, 13, 13}}, Global_IdxT{{13, 13, 13}}};
    for (const auto& corner : global_corners)
