...
public:
  ...
  void tearDown() {
   ...
   void testGetProcessCoordinates3D() {
    ...
    coupling::paralleltopology::ZYXTopology<3> topology{numberOfProcesses, topologyOffset};
  ...
  void testGetProcessCoordinates2D() {
    ...
    coupling::paralleltopology::ZYXTopology<2> topology{numberOfProcesses, topologyOffset};
