 ...
 *  @author Louis Viot
 */
class MacroscopicCellServiceTest : public CppUnit::TestFixture {

  CPPUNIT_TEST_SUITE(MacroscopicCellServiceTest);
  CPPUNIT_TEST(test<3>);
...
private:
  ...
  public:
    TestParticleInsertionConfiguration() :
        coupling::configurations::ParticleInsertionConfiguration(1, 1, 1, 
        1, 1, 1, 1, 1, 1, coupling::configurations::ParticleInsertionConfiguration::ParticleInsertionType::NO_INSERTION) {}
  ...
  public:
    TestMomentumInsertionConfiguration() : coupling::configurations::MomentumInsertionConfiguration(coupling::configurations::MomentumInsertionConfiguration::MomentumInsertionType::NO_INSERTION) {}
  ...
  public:
    TestBoundaryForceConfiguration() : coupling::configurations::BoundaryForceConfiguration<dim>(
  ...
  public:
    TestTransferStrategyConfiguration() : coupling::configurations::TransferStrategyConfiguration<dim>(coupling::configurations::TransferStrategyConfiguration<dim>::StrategyType::DirectTransferStrategy,
    {true}, 1) {}
  ...
  public:
    TestThermostatConfiguration() : coupling::configurations::ThermostatConfiguration(coupling::configurations::ThermostatConfiguration::ThermostatRegion::none) {}
  ...
  template <unsigned int dim> class TestMacroscopicCellConfiguration : public coupling::configurations::MacroscopicCellConfiguration<dim> {
  public:
    TestMacroscopicCellConfiguration() : coupling::configurations::MacroscopicCellConfiguration<dim>({1}, {1}, 1, "", 1, "") {}

    ~TestMacroscopicCellConfiguration() {}
...
CPPUNIT_TEST_SUITE_REGISTRATION(MacroscopicCellServiceTest);