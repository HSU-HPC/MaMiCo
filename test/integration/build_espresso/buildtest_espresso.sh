...
${LIBTOOL} --tag=CXX --mode=link ${COMPILER} -g ${BUILD_PATH}/tinyxml2.o ${BUILD_PATH}/RandomNumberService.o ${BUILD_PATH}/ParticleInsertionConfiguration.o ${BUILD_PATH}/scriptsdir.o  ${BUILD_PATH}/main_espresso.o -L${TCL_LIB_PATH} -l${LIB_TCL} -L${MPI_LIB_PATH} -l${LIB_MPI} ${ESPRESSOTCL_LIB_PATH} ${ESPRESSO_LIB_PATH} -o ${BUILD_PATH}/test_espresso
