...
* a C++17[^1] compiler installed (e.g. GCC 10 or newer)
* CMake version >= 3.13

[^1]: MaMiCo supports C++17 onwards, but the default Kokkos version 5.0.2 requires C++20. If using this version, a C++20 compatible compiler is required. However, Kokkos version 4.x can be used to reduce this to C++17 (e.g. GCC 7 or newer).
